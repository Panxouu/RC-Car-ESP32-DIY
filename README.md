...
| :--- | :--- |
| **📦 [Bill of Materials (BOM)](./RC-Car-ESP32-V1/BOM%20v1/README.md)** | **Purchase List & Printed Parts.** <br>Full list of hardware (Motors, Batteries, Screws) and the catalog of STL parts required for 3D printing.<br>---<br>**Lista de Compra y Piezas Impresas.**<br>Listado completo de hardware (Motores, Baterías, Tornillos) y catálogo de STLs para imprimir. |
